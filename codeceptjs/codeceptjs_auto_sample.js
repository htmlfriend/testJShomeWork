...
//   await I.amOnPage("https://otus.ru");
...
//   await I.fillField(
//     'form.js-login input[name^="email"]',
//     "auto_test_demo@demo.com"
//   );
...
//   await I.see(
//     "Такая пара логин/пароль не существует",
//     "form.js-login > div > .new-input-error"
//   );
// });
