...
const { MainPage } = require("../step6/mainPage");
const { FillData } = require("../step6/fillData");
const { buildUser } = require("../data/step6/buildUser");
const { CurrentPage } = require("../step6/currentTAskPage");
